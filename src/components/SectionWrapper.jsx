...
const SectionWrapper = ({ reverse, title, description, showBtn, showQr, mockupImg, banner }) => {
  return (
    ...
    ${banner}`}>
      ...
      w-11/12 sm:w-full minmd:w-3/4`}>
        <div className={`${styles.descDiv} ${reverse ? " fadeRightMini" : " fadeLeftMini"} ${reverse ? styles.textRight : styles.textLeft}`}>
          ...
          {showBtn && (
            <Button
              ...
              link="https://expo.dev/@lucidnature/nftmarket?release-channel=default"
        ...
        <div className={`flex-1 ${styles.flexCenter} p-8 sm:px-0`}>
          ...
          ${styles.flexCenter} p-8 sm:px-0`} src={mockupImg} alt="Mockup" />
        </div>
      </div>
